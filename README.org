...
#+END_SRC
* dired
Assuming you're reading this linearly, I haven't mentioned that I use evil-mode. Evil-mode is an implementation of vim's editing model in elisp. It's very complete, and very awesome.
...
initially I had a lot of issues with evil-leader as evil-mode would simply be disabled in modes like ibuffer, dired, and what have you, for good reason! Fortunately, I found out a way to make emacs and evil play together nicely permanently, and that's getting rid of insert state altogether (again, later explained). I've started using it a lot now, but I'd like to move this config to [[https://github.com/noctuid/general.el][general.el]]. 
...
there are significantly less context switches now. when I am in a new buffer, I know I am in emacs state, and can begin typing immediately. If I want to do anything evil, 
#+BEGIN_SRC emacs-lisp :tangle init.el
  (progn
